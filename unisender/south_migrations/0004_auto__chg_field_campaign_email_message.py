...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Campaign.email_message'
        db.alter_column(u'unisender_campaign', 'email_message_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['unisender.EmailMessage'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Campaign.email_message'
        raise RuntimeError("Cannot reverse this migration. 'Campaign.email_message' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Campaign.email_message'
        db.alter_column(u'unisender_campaign', 'email_message_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['unisender.EmailMessage']))
