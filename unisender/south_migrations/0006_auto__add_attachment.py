...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'unisender_attachment', (
        ...
        db.send_create_signal(u'unisender', ['Attachment'])


    def backwards(self, orm):
        # Deleting model 'Attachment'
        db.delete_table(u'unisender_attachment')
    ...
    models = {
        ...
        u'unisender.emailmessage': {
            ...
            'series_time': ('django.db.models.fields.TimeField', [], {'default': 'datetime.datetime(2014, 7, 22, 0, 0)'}),
