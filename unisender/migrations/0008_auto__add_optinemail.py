...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OptinEmail'
        db.create_table(u'unisender_optinemail', (
        ...
        db.send_create_signal(u'unisender', ['OptinEmail'])


    def backwards(self, orm):
        # Deleting model 'OptinEmail'
        db.delete_table(u'unisender_optinemail')
    ...
    models = {
        ...
        u'unisender.emailmessage': {
            ...
            'series_time': ('django.db.models.fields.TimeField', [], {'default': 'datetime.datetime(2014, 7, 25, 0, 0)'}),
        ...
        u'unisender.optinemail': {
            'Meta': {'object_name': 'OptinEmail'},
            'body': ('tinymce_4.fields.TinyMCEModelField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_error': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'list_id': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['unisender.SubscribeList']", 'unique': 'True'}),
            'sender_email': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'sender_name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'subject': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'sync': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
